...
export default function ContactPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    // For now, simulate success. Later you can wire this to an API route with Nodemailer.
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-primary/50 border border-white/10 rounded-xl focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all text-text-primary"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-primary/50 border border-white/10 rounded-xl focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all text-text-primary resize-none"
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-accent hover:bg-accent-hover disabled:bg-accent/50 text-primary font-bold rounded-xl transition-all shadow-lg shadow-accent/20"
                >
                  {isSubmitting ? (
            ...
            <div className="flex flex-col justify-between h-full space-y-10">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary mb-1">Endereço</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${COMPANY.email}`} className="text-text-secondary hover:text-accent transition-colors">
                      {COMPANY.email}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-primary mb-1">Telefone</h4>
                    <a href={`tel:${COMPANY.phone.replace(/\D/g, "")}`} className="text-text-secondary hover:text-accent transition-colors">
                      {COMPANY.phone}
                    </a>
                  </div>
                </div>
              ...
              {/* Google Maps Embed */}
              <div className="rounded-3xl overflow-hidden h-[250px] border border-border bg-secondary">
